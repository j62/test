  ...
  <tr>
    ...
    <td width='80%' align="right" valign="bottom">
      ...
      <td align="right" height="26" style="padding-right:60px;line-height:26px;">
			...
			您好：<span class="username" style="color:red;"><?=$_SESSION["user"]?></span>，欢迎进入茵曼商城后台管理系统
			[<a href="admin_loginout.php" target="_top">退出</a>]&nbsp;
			[<a href="../index.php" target="_blank">网站主页</a>]
			<?php }else{ ?>
			[<a href="../index.php" target="_blank">网站主页</a>]
			[<a href="admin_login.php" target="_blank">登录</a>]
			<?php }
			?>
      </td>
      </tr>
      <tr>
		...
		<dd><div class='itemsel' id='item1' onMouseMove="mv(this,'move',1);" onMouseOut="mv(this,'o',1);"><a href="index.php" onclick="changeSel(1)" target="menu">主菜单</a></div></dd>
		<dd><div class='item' id='item2' onMouseMove="mv(this,'m',2);" onMouseOut="mv(this,'o',2);"><a href="conf.php" onclick="changeSel(2)" target="main">新闻管理</a></div></dd>
		<dd><div class='item' id='item3' onMouseMove="mv(this,'m',3);" onMouseOut="mv(this,'o',3);"><a href="product_select.php" onclick="changeSel(3)" target="main">商品管理</a></div></dd>
		<dd><div class='item' id='item4' onMouseMove="mv(this,'m',4);" onMouseOut="mv(this,'o',4);"><a href="product_select.php" onclick="changeSel(4)" target="main">订单管理</a></div></dd>
		<dd><div class='item' id='item5' onMouseMove="mv(this,'m',5);" onMouseOut="mv(this,'o',5);"><a href="act_select.php" onclick="changeSel(5)" target="main">活动管理</a></div></dd>
		</dl>
		</td>
      </tr>
    </table></td>
